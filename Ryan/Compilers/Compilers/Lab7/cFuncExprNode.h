...
class cFuncExprNode : public cExprNode
{
    public:
            ...
            : cExprNode()
        {
            ...
            m_decl = dynamic_cast<cFuncDeclNode*>(name->GetDecl());
            cDeclsNode *args = m_decl->GetParams();
        ...
        cFuncDeclNode * GetDecl(){return m_decl;}
        string GetName(){ return ((cSymbol *)GetChild(0))->GetName();}
        cParamListNode * GetParamList() {return (cParamListNode *)GetChild(1);}
        virtual bool isFunc(){return true;}
    private:
    	cFuncDeclNode * m_decl;
};
